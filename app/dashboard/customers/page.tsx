              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="relative w-full sm:w-64">
                  ...
                  <Input
                    ...
                    className={cn("transition-all duration-200", isRTL ? "pr-8" : "pl-8")}
                  />
                </div>
              </div>
            </CardHeader>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b-2 border-border">
                      <th className={cn("p-3 text-sm font-semibold text-foreground", isRTL ? "text-right" : "text-left")}>
                        {isRTL ? "#" : "#"}
                      </th>
                      <th className={cn("p-3 text-sm font-semibold text-foreground", isRTL ? "text-right" : "text-left")}>
                    ...
                    {filteredTopCustomers.length > 0 ? (
                      filteredTopCustomers.map((customer, idx) => (
                        <tr key={idx} className="border-b hover:bg-primary/5 transition-colors duration-200">
                          <td className={cn("p-3 text-sm text-muted-foreground", isRTL ? "text-right" : "text-left")}>
                            {idx + 1}
                          </td>
                          <td className={cn("p-3 text-sm font-medium", isRTL ? "text-right" : "text-left")}>
                            {customer.customerId}
                          </td>
                          <td className={cn("p-3 text-sm", isRTL ? "text-right" : "text-left")}>
                            {customer.customerName || "-"}
                          </td>
                          <td className={cn("p-3 text-sm font-bold text-primary", isRTL ? "text-right" : "text-left")}>
            ...
            <CardHeader>
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <select
                  ...
                  className="px-4 py-2 border-2 rounded-lg bg-background hover:border-primary/50 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary/20"
                >
            ...
            <CardContent>
              {selectedCity ? (
                ...
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <p>{isRTL ? "اختر منطقة لعرض العملاء" : "Select a city to view customers"}</p>
                </div>
              )}
            </CardContent>
          </Card>
